...
Vdut::Vdut(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , in_2{vlSymsp->TOP.in_2}
    , in_3{vlSymsp->TOP.in_3}
    , in_4{vlSymsp->TOP.in_4}
    , op{vlSymsp->TOP.op}
...
static void _eval_initial_loop(Vdut__Syms* __restrict vlSymsp) {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/ustc/ysyx-workbench/npc/vsrc/dut.sv", 1, "",
...
static void traceInit(void* voidSelf, VerilatedVcd* tracep, uint32_t code) {
    ...
    tracep->scopeEscape(' ');
    Vdut___024root__traceInitTop(vlSelf, tracep);
    tracep->scopeEscape('.');
}
...
void Vdut::trace(VerilatedVcdC* tfp, int, int) {
    ...
    Vdut___024root__traceRegister(&(vlSymsp->TOP), tfp->spTrace());
}
